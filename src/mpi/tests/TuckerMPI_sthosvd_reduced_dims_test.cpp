...
// specify precision
  ...
  const TuckerMPI::TuckerTensor<scalar_t>* oldGramSolution = TuckerMPI::STHOSVD<scalar_t>(T, core_dims, nullptr, true, false, false);
  const TuckerMPI::TuckerTensor<scalar_t>* newGramSolution = TuckerMPI::STHOSVD<scalar_t>(T, core_dims, nullptr, false, false, false);
  const TuckerMPI::TuckerTensor<scalar_t>* LQSolution = TuckerMPI::STHOSVD<scalar_t>(T, core_dims, nullptr, false, false, true);
