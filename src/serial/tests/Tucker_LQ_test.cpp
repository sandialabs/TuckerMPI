...
// Specify precision
  ...
  scalar_t R3[4] = {-13.453624047073712, -9.811482730462597,
                  0, 9.205151092178458};
  scalar_t R4[36] = {-7.874007874011811,-5.080005080007620,-2.667002667004001,-7.366007366011051,-3.048003048004572,-6.604006604009907,-6.858006858010288,-5.588005588008382,-3.683003683005525,
  ...
  (*size)[1] = 2; 
  (*size)[2] = 2;
  Y = Tucker::MemoryManager::safe_new<Tucker::Tensor<scalar_t>>(*size);
  for(int i=0; i<36; i++)
    Y->data()[i] = content[i];
