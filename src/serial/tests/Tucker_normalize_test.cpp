...
int main()
{
  ...
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_mm0.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_mm1.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_mm2.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_mm3.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_sc0.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_sc1.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_sc2.txt");
  ...
  // Read true solution from file
  true_sol = Tucker::importTensor<double>("input_files/3x5x7x11_sc3.txt");
