...
#
set(CMD "${MPIEXEC} -n 1 ${TEST_EXE_DIR}/MpiKokkosTucker_streaming_sthosvd --parameter-file compress.txt")
message(STATUS ${CMD})
...
#
set(CMD "${MPIEXEC} -n 1 ${TEST_EXE_DIR}/MpiKokkosTucker_reconstruct --parameter-file reconstruct.txt")
message(STATUS ${CMD})
execute_process(COMMAND ${BASH} -c ${CMD} RESULT_VARIABLE RES)
if(RES)
